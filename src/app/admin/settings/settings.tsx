            ...
            <div >
                ...
                <div className="flex row mt-2 flex-wrap">
                    {workingdays.map((x, index) =>
                        <Card key={x.day} className="mr-4 mt-4 ">
                            ...
                            <CardContent>
                                    ...
                                    <div className="flex row m-2">
                                        <label htmlFor="from" className="mr-2" >No:</label>
                                        <input type="time" id="from" name="from" defaultValue={x.breakfrom} 
                                        disabled={!x.statuss}
                                    ...
                                    <div>
                                        <label htmlFor="to" className="mr-2">Līdz:</label>
                                        <input type="time" id="to" name="to" defaultValue={x.breakto} disabled={!x.statuss} onChange={(e) => setWorkingdays(workingdays => workingdays.with(index, { ...workingdays[index], breakto: e.target.value == "" ? "00:00" :  e.target.value  }))} style={{ border: "1px solid hsl(220 13% 91%)", borderRadius: "10px", padding: 4 }} required />
                                    </div>
                            </CardContent>
                        </Card>
                    )}
