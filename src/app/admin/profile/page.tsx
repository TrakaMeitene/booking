...
export default function Profile() {
    ...
    const [occupations] = useState(["Frizieris", "Vizāžists", "Manikīrs", "Kosmetologs", "Skropstu meistars", "Masieris", "Stilists", "Lāzerepilācija", "Tetovēšana/pīrsingi", "Fitness", "Masāža", "Fotogrāfs", "Fizioterapeits", "Psihologs", "Podologs"])
