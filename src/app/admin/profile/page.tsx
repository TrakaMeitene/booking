...
export default function Profile() {
    ...
    const [occupations] = useState(["Frizieris", "Vizāžists", "Manikīrs", "Kosmetologs", "Skropstu meistars", "Masieris", "Stilists", "Lāzerepilācija", "Tetovēšana/pīrsingi", "Fitness", "Masāža", "Fotogrāfs", "Fizioterapeits", "Psihologs", "Podologs", "Programmēšanas pakalpojumi"])
    ...
    return (
        <main className="bg-white">
            ...
            <div className="flex flex-row flex-wrap mb-[60px]">
                ...
                <Card className="h-fit mt-2 ml-2 mb-2">
                    <CardContent>
                        ...
                        {user?.abonament === "bezmaksas" &&
                            <form onSubmit={abonament}>
